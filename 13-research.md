...
启动一个**后台 Agent（background agent）**去开展资料调研，以便在它阅读资料的同时，你可以继续推进手头的主线工作。

它的核心职责：

1. **严格对照一手权威资料（primary sources）调查问题** —— 查阅官方文档、源代码、技术规范与第一方 API —— 绝不采信任何未经核实的二手博客或网文转述。每一项结论断言，都必须能够沿着线索追溯到拥有该结论的权威源头。
