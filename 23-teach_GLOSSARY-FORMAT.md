...
**Hypertrophy（肌肥大）**:
在反复的训练刺激中，由机械张力与代谢压力共同驱动的肌肉骨骼体积增长。
_Avoid（禁用黑话）_: 增肌变壮, 膨胀
...
- **立场鲜明，去芜存菁（Be opinionated）**：当同一个概念在市面上有五花八门的混淆叫法时，坚定挑选出最权威的一个，并将其余所有的口头禅全部列入 `_Avoid_` 禁用清单 —— 这正是通用语言得以提纯的精髓所在；
- **定义必须极其紧凑（Keep definitions tight）**：最多不超过一至两句话。**清晰定义它“是什么（what it IS）”，而不是怎么做（how to do it）**；
