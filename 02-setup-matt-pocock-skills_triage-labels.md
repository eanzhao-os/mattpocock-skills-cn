# 02-setup-matt-pocock-skills / triage-labels.md 精读（规范工单分流角色与实际标签映射字典（Triage Labels））
...
- 当某个技能指示“赋予 AFK-ready 就绪标签”或类似分流指令时，查阅本表中对应的具体标签字符串进行标注；
- 每个具体代码仓库均可自由修改右侧的实际标签列，以匹配团队既有的工单标签体系与命名习惯。
